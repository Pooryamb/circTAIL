...
os.system("./circTailAlignerZeroTGap.o " + ReadFile[0] + " " + R_temp[0] +  " -1000 1000 1000 " +" > ../intermediates/R_alignment_reversed_BeforeSelection_BeforeTgapCorrection_BeforeOverLapCorrection.txt")
